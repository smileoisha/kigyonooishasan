...
${tagList}
3. この面談で顧客が抱えている経営課題を最大5個、短い名詞句（10文字以内）で配列にしてください。課題が読み取れない場合は空配列。例：["人手不足","原価率上昇","資金繰り"]
4. 次回までに顧客または支援者が取るべきアクションを最大5個、具体的な動詞句で配列にしてください。読み取れない場合は空配列。例：["見積もり3社取得","銀行に融資相談"]
${needsTheme ? '5. この会議のテーマを10文字以内の名詞句で1つ作成してください（例：「資金繰り相談」「契約内容の確認」）' : ''}

【必須】以下のJSON形式のみで返してください。説明文・前置き・コードブロック不要:
${needsTheme ? '{"summary":"要約文","tags":["タグ1"],"issues":["課題1"],"nextActions":["アクション1"],"theme":"テーマ"}' : '{"summary":"要約文","tags":["タグ1"],"issues":["課題1"],"nextActions":["アクション1"]}'}`;
